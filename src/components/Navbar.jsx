...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="sticky top-5 z-50 py-3 mt-5 backdrop-blur-lg border border-neutral-700/80 w-3/5 mx-auto bg-black bg-opacity-50 pl-4 shadow-md" style={{ borderRadius: '25px', boxShadow: '0 25px 25px rgba(0, 0, 0, 0.2)' }}>
